# Pairing a modern coumputer with a distro.

Some people drink whiskey like it’s a religion. Aged in oak, stored underground, blessed by a Scottish wizard — anything less is heresy. Same energy as the Arch crowd who think you should build your distro from primordial source code and document your suffering on the forums.
...
It’s a rig built for fresh kernels, current Mesa, and once i booted into Fedora for the first time, it really felt like home.

My old desktop still runs Pop!_OS. I boot it occasionally, check in on Cosmic’s progress, and use it for LAN lab work. It’s a solid machine, just built for a different era of computing.

Fedora is Bourbon in the adult sense: not flashy, not ceremonial, not something you have to justify to purists. It’s the choice you make when you know what you like.
